    ...
    <div class="row">
      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pd5">
        <ol class="breadcrumb breadcrumb-arrows">
          ...
          <li>
            <span><span style="color: #777777">Tìm kiếm sản phẩm</span></span>
          </li>
        </ol>
      </div>
    </div>
              ...
              <div class="layered">
                ...
                <div class="block_content collapse" id="collapseExample2">
                  <div class="group-filter card card-body" style="border:0;padding:0" aria-expanded="true">
                    <div class="layered_subtitle dropdown-filter"><span>Danh mục</span><span class="icon-control"><i class="fa fa-minus"></i></span></div>
    ...
    <div class="col-md-9 col-sm-12 col-xs-12">
      <div class="wrap-collection-title row">
        <div class="col-md-8 col-sm-12 col-xs-12">
          <h1 class="title">
            Bạn tìm kiếm với từ khoá: {{$tukhoa}}
          </h1>
            ...
            <div class="product-detail clearfix">
              <div class="pro-text">
                <a href="{{url('chi-tiet/'.$pro->slug_product)}}" style=" color: black;
                      font-size: 14px;text-decoration: none;" href="{{url('chi-tiet/'.$pro->slug_product)}}" title="{{$pro->product_name}}" inspiration pack>
                  {{$pro->product_name}}
                </a>
              </div>
              <div class="pro-price">
